...
const DADOS_COUNTERS = {
    ...
    "Bonnie": ["Charlie", "Ruffs", "Leon", "Kaze", "Mina"],
    "Brock": ["RT", "Byron", "Pierce", "Najia", "Piper", "Jae Yong", "Kaze", "Max"],
    ...
    "Clancy": ["Charlie", "Ruffs", "Cordelius", "Otis"],
   ...
   "Cordelius": ["Nita", "Frank", "Otis", "Chester", "Edgar", "Ruffs", "Sirius", "Sandy", "Gale"],
    ...
    "Damian": ["Cordelious", "Otis", "Emz", "Colt", "Griff", "Colette", "Chester", "Surge", "Charlie", "Gale"],
    "Darryl": ["Spike", "Cordelious", "Otis", "Chester", "Colette", "Clancy", "Gale", "Lou", "Bull", "Nita"],
    "Doug": ["Cordelious", "Otis", "Chester", "Charlie", "Griff", "Colette", "Bull", "Pearl", "Crow", "Byron", "Emz", "Lou"],
    "Draco": ["Colette", "Cordelious", "Otis", "Spike", "Chester", "Charlie"],
    "Dynamike": [""],
    "Edgar": [""],
    "El Primo": ["Colette", "Cordelious", "Otis", "Gale"],
    "Emz": [""],
    "Eve": [""],
    "Fang": [""],
    "Finx": [""],
