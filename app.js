    ...
    <div class="round-details-view" style="background: var(--bg-cards); padding: 25px; border-radius: 12px; border: 1px solid var(--borda-destaque);">
        ...
        <div class="picks-container" style="display:flex; justify-content:center; align-items:center; gap: 40px; margin-top: 15px;">
            ...
            <div style="text-align:center; display:flex; flex-direction:column; align-items:center;">
                <div style="width:360px; height:360px; padding:8px; box-sizing:border-box; display:flex; align-items:center; justify-content:center; border-radius:12px; border:2px solid var(--borda-destaque); background:var(--bg-geral);">
                    <img src="element/maps/${formatImg(roundMD3.mapa)}.png" style="width:100%; height:100%; border-radius:8px; object-fit:contain; display:block;" onerror="this.src='element/maps/default.png'">
                </div>
